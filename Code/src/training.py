...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            all_labels = ['dyed-lifted-polyps', 'dyed-resection-margins', 'esophagitis']
            binary_labels = [0,1,2]
            temp = -1
            ...
            model.save(r"C:\Users\way2m\OneDrive\Documents\Python Projects\IBS Project COde\IBS_RCNN\dataset\disease.h5")
            ...
            model.save_weights(r"C:\Users\way2m\OneDrive\Documents\Python Projects\IBS Project COde\IBS_RCNN\dataset\disease_weights.h5")
